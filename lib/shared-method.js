 ...
 * @property {Array} accessScopes See `options.accessScopes`.
 ...
 * @property {Array} [accessScopes] Defines an list of scopes.
...
function SharedMethod(fn, name, sc, options) {
  ...
  this.accessScopes = options.accessScopes || fn.accessScopes || undefined;
